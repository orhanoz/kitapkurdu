Vue.component("book", {
  ...
  <div class="card col-md-10" style="padding-top: 18px;">
    <div
      ...
      style="margin-bottom: 2%; border: 1px solid #f8b739; border-radius: 6px;"
    >
      <div class="col-md-2">
        <img
          v-if="book.volumeInfo.imageLinks"
          :src="book.volumeInfo.imageLinks.smallThumbnail"
          alt="resim yuklenemedi"
          style="padding: 20px;"
        />
      </div>
      <div class="col-md-2">
      ...
      <button
        v-bind:id="book.selfLink"
        class="btn btn-lg btn-primary"
        v-on:click="makeComment(book.selfLink)"
        style="
          float: right;
          width: 120px;
          height: 40px;
...
var app = new Vue({
  ...
  methods: {
    ...
    searchBooks: function () {
      ...
      axios
        .get(
          `https://www.googleapis.com/books/v1/volumes?q=${searchTextFormatted}&startIndex=${
            this.pageIndex - 1
          }`
        )
